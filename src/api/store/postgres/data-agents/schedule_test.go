...
func (s *scheduleTestSuite) TestPGSchedule_FindOneByUUID() {
	...
	schedule := testdata.FakeSchedule(s.tenantID, s.username)
...
func (s *scheduleTestSuite) TestPGSchedule_FindAll() {
	...
	schedules := []*models.Schedule{
		testdata.FakeSchedule(s.tenantID, s.username),
		testdata.FakeSchedule(s.tenantID, s.username),
		testdata.FakeSchedule(tenantID2, s.username),
	}
